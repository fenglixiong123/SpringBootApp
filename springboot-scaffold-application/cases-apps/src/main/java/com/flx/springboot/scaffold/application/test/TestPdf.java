...
public class TestPdf {
    ...
    public void downloadPdfFromTemplate(HttpServletResponse response){
        ...
        Optional.ofNullable(resource).ifPresent(e->{
            ...
            PdfTemplateUtils.downloadPdf(PdfTemplateUtils.PdfContent.of(textMap,null,tableMap),"A001",templatePath,response);
        });
    }
    ...
    public void downloadPdf(HttpServletResponse response){
        ...
        try {
            PdfUtils.generatePdfDesk("D:\\pdf\\","G.pdf",documentInfo);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
