package com.flx.springboot.rabbitmq.controller;

import com.flx.springboot.rabbitmq.entity.Student;
import com.flx.springboot.scaffold.common.result.ResultResponse;
import com.flx.springboot.scaffold.common.utils.json.JsonUtils;
import com.flx.springboot.rabbitmq.service.producer.RabbitProducer;
...
public class RabbitController {
    ...
    public ResultResponse<String> sendDirect() {
        ...
        return ResultResponse.success("RabbitMQ发送成功！");
    }
